...
extern void LIB_CLASS txInit(char **argv, const char *s);
...
extern TXWINDOW LIB_CLASS txCreateWindow(char **argv, int width, int height, const char *title = NULL);
extern TXWINDOW LIB_CLASS txCreateWindow(char **argv, int x, int y, int width, int height, const char *title = NULL);
