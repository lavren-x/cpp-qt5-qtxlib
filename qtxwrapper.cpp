/*
    ...
    This file contains realisation of txXXXXXX wrapper functions to provide end-user communication.
...
{
    return qtx->applicationMustBeClosed();
}
...
{
    return qtx->applicationDirectoryPath();
}

const char *txFromAppDirPath(const char *subDirectoryPath)
{
    return qtx->fromApplicationDirectoryPath(subDirectoryPath);
}
