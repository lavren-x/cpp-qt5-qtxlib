...
{
public:
    AppExitEvent() :  QEvent(AppExitEventType) {}
};
...
public:
    ...
    void notifyIcon(const char *title, const char *text, const char *filename = NULL);
    ...
    const char *applicationDirectoryPath();
    const char *fromApplicationDirectoryPath(const char *subDirPath);
    void playSound(const char *filename);
    bool applicationMustBeClosed();
